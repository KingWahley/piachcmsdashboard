      ...
      <div className="main-grid">
        <div className="card">
          ...
          <div className="qa-grid">
            <Link href="/projects/new" className="qa-btn" style={{ textDecoration: 'none' }}>
            ...
            <Link href="/vacancies/new" className="qa-btn" style={{ textDecoration: 'none' }}>
              <div className="qa-icon">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <Link href="/blog/new" className="qa-btn" style={{ textDecoration: 'none' }}>
              <div className="qa-icon">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <Link href="/team/new" className="qa-btn" style={{ textDecoration: 'none' }}>
              <div className="qa-icon">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <div className="card">
          <div className="card-header">
            ...
            <Link href="/messages" className="card-action">View all →</Link>
          </div>
          <div>
      ...
      <div className="bottom-grid">
        <div className="card">
          <div className="card-header">
            ...
            <Link href="/appointments/calendar" className="card-action">Full calendar →</Link>
          </div>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <Link href="/job-applications" className="card-action">View all {applications.length} →</Link>
          </div>
          <div>
